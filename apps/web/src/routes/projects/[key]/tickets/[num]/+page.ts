...
import type { Comment, ProjectDetail, TicketActivity, TicketDetail } from "@issues/api";
...
export const load: PageLoad = async ({ fetch, params, parent }) => {
  ...
  const [projectRes, ticketRes, commentsRes, activityRes] = await Promise.all([
  ...
  return { user, project, ticket, comments, activity };
};
